...
// ===== HEADER SCROLL STATE =====
// Purpose: Adds shadow + blur to the header when user scrolls down
...
// ===== MOBILE MENU TOGGLE =====
// Purpose: Opens/closes the mobile navigation panel
// Triggers: burger button click
...
// ===== REVEAL ON SCROLL =====
// Purpose: Fades + slides elements into view as they enter the viewport
// Triggers: IntersectionObserver threshold .12
var io=new IntersectionObserver(function(es){es.forEach(function(e){if(e.isIntersecting){e.target.classList.add('in');io.unobserve(e.target);}});},{threshold:.12});
document.querySelectorAll('.reveal').forEach(function(el){io.observe(el);});

// ===== REVIEWS CAROUSEL =====
// Purpose: Auto-advances testimonial slides every 6 seconds; dot buttons allow manual nav
// Triggers: setInterval + dot button clicks
